...
ifeq "$(strip $(GO_BUILD_PACKAGES))" ""
	$(error GO_BUILD_PACKAGES can't be empty!)
endif
ifeq "$(strip $(GO_BUILD_PACKAGES_EXPANDED))" ""
	$(error GO_BUILD_PACKAGES_EXPANDED can't be empty! Check that they are expandable with `go list`.)
endif
